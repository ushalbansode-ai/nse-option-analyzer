...
class AdvancedOptionSignalGenerator:
    ...
    print("=" * 70)
    print("🛰️ ADVANCED NSE OPTION SIGNALS - COMPLETE ANALYSIS")
    print("📊 Using: OI, COI, Price, Change, IV, Delta, Gamma, ATM±5 Strikes")
    print("=" * 70)
    ...
    if signals:
        ...
        print("❔ No strong signals - market may be neutral")
    ...
    <body>
        <div class="container">
            ...
            <div class="last-update">
                ...
                <br><strong>Analysis Focus:</strong> ATM ±5 strikes only
    ...
    html += """
            <div style="margin-top: 20px; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 15px;">
                <div style="background: #e8f5e8; padding: 15px; border-radius: 8px;">
                    ...
                    <p><strong>Focus:</strong> ATM ±5 strikes only</p>
                    <p><strong>Priority:</strong> ATM → Near-ATM → Slight OTM</p>
